...
avg_em_by_state <- nei_by_pollutant %>% 
  ...
  summarise(avg_em = mean(Total.Emisions))
...
ggplot(data = CO2_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
...
ggplot(data = CO_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Carbon Monoxide Emisions",
...
ggplot(data = CH4_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Methane Emisions",
...
ggplot(data = NOx_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Nitrous Oxide Emisions",
...
ggplot(data = Cr_VI_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Chromium (VI) Emisions",
...
ggplot(data = Mn_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Manganese Emisions",
...
ggplot(data = Hg_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Mercury Emisions",
...
ggplot(data = Ni_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Nickel Emisions",
...
ggplot(data = PM10_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Large Particulate Matter (<10um but >2.5um) Emisions",
...
ggplot(data = PM25_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Fine Particulate Matter (<2.5um) Emisions",
...
ggplot(data = SO2_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Sulfur Dioxide Emisions",
...
ggplot(data = VOC_em, mapping = aes(x = Year, y= Total.Emisions)) +
  geom_point(aes(color = CAV_adoption)) +
  geom_smooth(aes(color = CAV_adoption)) +
  labs(
    title = "Volatile Organic Compounds (VOC) Emisions",
